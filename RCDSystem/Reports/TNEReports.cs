...
{
    public abstract class TNEReports
    {
    ...
    public class MSPDFFooter : PdfPageEventHelper
    {
        ...
        private void ImprimeRodape(PdfWriter writer, Document doc)
        {
            ...
            if (ImprimirRodapePadrao)
            {
                ...
                #region Coluna TNE
                Image foot = Image.GetInstance(BasePath + @"\wwwroot\assets\img\RCD_logo.jpg");
                ...
                cell = new PdfPCell(new Phrase("RCD System", negrito));
                cell.Border = 0;
                micros.AddCell(cell);
                cell = new PdfPCell(new Phrase("www.rcdsystem.com.br", font));
                cell.Border = 0;
                micros.AddCell(cell);
                ...
                cell.HorizontalAlignment = Element.ALIGN_RIGHT;
                micros.AddCell(cell);
                cell = new PdfPCell(new Phrase("RCD System", font));
                cell.Border = 0;
                cell.HorizontalAlignment = Element.ALIGN_RIGHT;
                micros.AddCell(cell);
        ...
        private void ImprimeCabecalho(PdfWriter writer, Document doc)
        {
            ...
            if (ImprimirCabecalhoPadrao)
            {
                ...
                {
                    foot = Image.GetInstance(BasePath + @"\wwwroot\assets\img\RCD_logo.jpg");
                }
                foot.ScalePercent(60);
