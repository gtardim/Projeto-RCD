...
{
    public class ProcessoReports : TNEReports
    {
        ...
        public ProcessoReports(int cliente, int status, string data_i, string data_f)
        {
            Paisagem = false;
            _cliente = cliente;
            _status = status;
        ...
        public override void MontaCorpoDados()
        {
            ...
            var proc = new DAL.ProcessoDAL().ObterProcessosRP(Cliente, Status, Data_i, Data_f);
            if (proc != null)
            {
