...
function limparTabela() {
    $('#tableTipoDespesa').DataTable().clear().destroy();
}
...
function validaExclusao(cod_tipo) {
            ...
            $.ajax({
                type: 'POST',
                url: '/TipoDespesa/ValidaExclusao',
                data: {
                    cod_tipo
                },
                success: function (res) {
                    if (res.tipodes == null) {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Erro!' + "<br>" +"Tipo de Despesa Possui Despesa Cadastrada",
                            showConfirmButton: false,
                            timer: 2999
                        });
                    }
