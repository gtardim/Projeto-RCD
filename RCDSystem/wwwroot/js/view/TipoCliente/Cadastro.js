...
function limparTabela() {
    $('#tableTipoCliente').DataTable().clear().destroy();
}
...
function carregaTabela(res) {
    ...
    for (var i = 0; i < res.length; i++) {
        action = '<td> <button class="btn btn-outline-primary btn-rounded mb-2" onclick="showEditModal(\'' + res[i].cod_tipo + '\',\'' + res[i].descricao + '\')">Editar</button> </td> <td> <button class="btn btn-danger mb-2" onclick ="excluir(' + res[i].cod_tipo + ')">Excluir </button> </td>';
